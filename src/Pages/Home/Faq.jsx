...
const panels = [
	{
		label: 'Minting Price',
		content: 'Each NFT Tikcet price is 0.01 ',
	},
	{
		label: 'Mint Maximum',
		content: 'Each user can mint up to 100 tickets.',
	},
	{
		label: 'How to get $PDM Tokens?',
		content: 'For each NFT minting, user will get ..... $PDM tokens. ',
	},
];
